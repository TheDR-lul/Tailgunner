...
impl UIPattern {
    ...
    fn parse_event_pattern(
        ...
        // Map UI event name to GameEvent (only available events)
        let game_event = match event_str {
            "Hit" => GameEvent::Hit,
            "CriticalHit" => GameEvent::CriticalHit,
            "TargetHit" => GameEvent::TargetHit,
            "TargetDestroyed" => GameEvent::TargetDestroyed,
            "TargetSetOnFire" => GameEvent::TargetSetOnFire,
            "TargetSeverelyDamaged" => GameEvent::TargetSeverelyDamaged,
            "AircraftDestroyed" => GameEvent::AircraftDestroyed,
            "ShipDestroyed" => GameEvent::ShipDestroyed,
            "TankDestroyed" => GameEvent::TankDestroyed,
            "VehicleDestroyed" => GameEvent::VehicleDestroyed,
            "EngineRunning" => GameEvent::EngineRunning,
            "EngineOverheat" => GameEvent::EngineOverheat,
            "OilOverheated" => GameEvent::OilOverheated,
            "Shooting" => GameEvent::Shooting,
            "CrewKnocked" => GameEvent::CrewKnocked,
            "MissionObjectiveCompleted" => GameEvent::MissionObjectiveCompleted,
            "MissionFailed" => GameEvent::MissionFailed,
            "MissionSuccess" => GameEvent::MissionSuccess,
            "Achievement" => GameEvent::Achievement,
            "ChatMessage" => GameEvent::ChatMessage,
            "TeamChatMessage" => GameEvent::TeamChatMessage,
            "AllChatMessage" => GameEvent::AllChatMessage,
            "SquadChatMessage" => GameEvent::SquadChatMessage,
            "EnemyChatMessage" => GameEvent::EnemyChatMessage,
            "FirstStrike" => GameEvent::FirstStrike,
            "ShipRescuer" => GameEvent::ShipRescuer,
            "Assist" => GameEvent::Assist,
            "BaseCapture" => GameEvent::BaseCapture,
            "TeamKill" => GameEvent::TeamKill,
            "PlayerDisconnected" => GameEvent::PlayerDisconnected,
            "Crashed" => GameEvent::Crashed,
            "UserTriggered" => GameEvent::UserTriggered,
            _ => {
